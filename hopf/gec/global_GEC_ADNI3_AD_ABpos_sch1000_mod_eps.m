...
load ('tseries_ADNI3_AD_MPRAGE_IRFSPGR_sch1000_N238rev.mat');
load('results_f_diff_fce_cond1_ADNI3_AD_sch1000.mat');
...
save(sprintf('ADNI3_AD_ABpos_GECglo_cnd_%03d_sch1000_mod_eps_1_2_ratio_SC_max02.mat',cnd),'Ceffgroup');
