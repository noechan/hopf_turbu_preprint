...
function hopf_DTI_Grange_HC_ABneg(s,condition)
...
%% Parameters HOPF
Tmax=197;
omega = repmat(2*pi*f_diff_HC_ABneg',1,2); omega(:,1) = -omega(:,1); %angular velocity
...
save(sprintf('WG_%03d_%d_ADNI3_HC_ABneg_GEC_sch1000.mat',s,condition),'InfoCascade','InfoFlow','Turbulence','err_hete');
