...
function hopf_DTI_Grange_HC_ABpos(s,condition)

%load data
load results_f_diff_fce_cond1_ADNI3_HC_ABpos_sch1000.mat; % load frequency with maximal power (of narrowly filtered data) by area computed in script Compute_Hopf_Freq_hc.m
load empirical_spacorr_rest_cond_1_ADNI3_HC_ABpos_sch1000.mat; %load empirical FC computed in script Empirical_corrfcn_hc.m
load ADNI3_HC_ABpos_GECglo_cnd_001_sch1000_mod_eps_1_2_ratio_SC_max02.mat; %load generative effective connectivity 
...
%% Parameters HOPF
Tmax=197;
omega = repmat(2*pi*f_diff_HC_ABpos',1,2); omega(:,1) = -omega(:,1); %angular velocity
...
save(sprintf('WG_%03d_%d_ADNI3_HC_ABpos_GEC_sch1000.mat',s,condition),'InfoCascade','InfoFlow','Turbulence','err_hete');
