function infocapacity_hopf_errorhete_HC_ABpos(s,condition)
...
%% Parameters HOPF
Tmax=197;
omega = repmat(2*pi*f_diff_HC_ABpos',1,2); omega(:,1) = -omega(:,1);
dt=0.1*TR/2;
sig=0.01;
dsig = sqrt(dt)*sig;
...
save(sprintf('Wtrials_%03d_%d_%s_ADNI3_HC_ABpos_GEC_sch1000.mat',s,condition,measure),'infocapacity','susceptibility');
