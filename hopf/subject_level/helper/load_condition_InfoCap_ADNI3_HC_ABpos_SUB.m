function vcondition = load_condition_InfoCap_ADNI3_HC_ABpos_SUB(trials, cond, nSub, baseDir)
% Subject-level loader for HC_ABpos
% Loads files:
% results/Wtrials/HC_ABpos/Wtrials_%03d_%d_err_hete_ADNI3_HC_ABpos_GEC_sch1000_SUB%03d.mat
%
% Returns:
