...
alldir = '/path/to/ADNI3/code/HPC_Hopf_SUB_DTI_1000_Staging/results/G_range/HC_ABneg/';

saveDir = fullfile(alldir, 'optG_HC_ABneg');
...
% -------------------------------------------------
% GROUP-LEVEL mean optimal G (HC_ABneg group)
% -------------------------------------------------
mean_optG_HC = mean(optG_all_subjects);
std_optG_HC  = std(optG_all_subjects);

fprintf('\nGroup-level mean optimal G (HC_ABneg): %.4f\n', mean_optG_HC);
fprintf('Standard deviation: %.4f\n', std_optG_HC);

% Save group summary
save(fullfile(saveDir, 'optG_HC_ABneg_group_stats.mat'), ...
