function hopf_DTI_Grange_HC_ABpos_GEC_SUB(nsub, s, condition)
...
%
% Saves:
%   WG_nsub_s_condition_ADNI3_HC_ABpos_GEC_sch1000.mat
...
if nsub < 1 || nsub > NSUB_ABpos
    error('nsub=%d is out of range for HC Aβ+ subjects (1..%d).', nsub, NSUB_ABpos);
end
...
gec_file = fullfile(code_dir,'data','GEC_SUB_ADNI3_HC_ABpos',sprintf('GEC_SUB_%03d_ADNI3_HC_ABpos_GEC.mat', nsub));
...
fprintf('HC Aβ+ subject nsub=%d | G index s=%d | G=%.2f\n', nsub, s, G);
...
%% Save results
out_name = fullfile(out_dir,'G_range','HC_ABpos',sprintf('WG_%03d_%03d_%d_ADNI3_HC_ABpos_GEC_sch1000.mat', ...
                   nsub, s, condition));
