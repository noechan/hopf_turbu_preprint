...
turbu_MNI152_2mm_path = (
    ...
    / "turbu_diff_mci_ad_lam1_sch1000_N145_2mm.nii.gz"
)
...
# Save to CSV
csv_path = output_dir / (
    "correlation_results_with_nulls_genesAD_turbulam1_MCI_AD_"
...
ax.set_title("Correlation between Turbulence Lambda 1 and Gene expression (fsaverage 41k)")
ax.legend()
plt.tight_layout()
figure_path = output_dir / (
    "correlation_plot_genesAD_turbulam1_MCI_AD_"
