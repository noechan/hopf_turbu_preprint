...
from src.pipelines.train_eval_pipelines_constrained import (
...
if __name__ == "__main__":
    ...
    for classification in classifications:
        for data_type in data_files.keys():
            print(f"Training {classifier} with constrained parameters")
            ...
            # Load constrained parameters file
            ...
            elif classification == "HCpos_vs_MCIpos":
                parameters["GROUPS"] = {"HC_ABpos": 0, "MCI_ABpos": 1}
            ...
            print(
                f"Running constrained pipeline ({classifier}) on {classification} | {data_type}"
            )
