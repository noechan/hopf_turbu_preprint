...
# === Node-wise permutation/FDR file (MCI_ABpos vs AD_ABpos) ===
nodewise_file = (
    nodewise_dir
...
ax.set_title(
    ...
    'Bottom 30% AdjP Turbulence Nodes: MCI_ABpos vs AD_ABpos',
    pad=20
)
ax.grid(True)
...
out_file = os.path.join(
    plot_path,
    "Radar_MCIpos_vs_ADpos_lambda001_nodewise_permFDR_bottom30AdjP_DMN_topright_purple.pdf"
)
