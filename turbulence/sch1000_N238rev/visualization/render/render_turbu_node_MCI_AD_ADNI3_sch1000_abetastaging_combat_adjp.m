%% Manuscript Figure 4b: MCI Aβ+ versus AD Aβ+ node-wise map
...
pval_file = fullfile(P.nodewise_stats, ...
    'NodeWise_Turbu_lambda_0_01_MCI_ABpos_vs_AD_ABpos_permFDR.xlsx');
...
fprintf('MCI+ vs AD+, lambda=0.01: -log10(adjP) range %.6f to %.6f\n', ...
    rangemin, rangemax);

save('nodewise_neglog10_adjP_MCI_ABpos_vs_AD_ABpos_lambda_0_01.mat', ...
    'adj_p', 'neglog_adjP', 'rangemin', 'rangemax', 'pval_file');

rendersurface_schaefer1000( ...
    neglog_adjP, rangemin, rangemax, 0, 'Purples9', 1);
print('render_MCI_AD_adjP_neglog10_purples', '-dpng');
savefig('render_MCI_AD_adjP_neglog10_purples.fig');
