%% Create timeseries for turbulence across multiple parcellations: MCI_IRFSPGR
...
batch_path = { ...
    'ADNI3_MCI_IRFSPGR_batch_1_extended'};

tseries_path = { ...
    'ADNI3_MCI_IRFSPGR_batch_1_N238rev'};
...
for batch = 1:numel(batch_path)
    ...
    fprintf('\nProcessing MCI_IRFSPGR batch %d...\n', batch);
    ...
    connIDs_varname  = sprintf('connIDs_BIDS_IRFSPGR_60_89_batch_%d_MCI', batch);
    ...
    for p = 1:numel(parcellations)
        ...
        save_filename = sprintf( ...
            'tseries_ADNI3_MCI_IRFSPGR_batch_%d_%s_matching_QC.mat', ...
            batch, parc_name);
