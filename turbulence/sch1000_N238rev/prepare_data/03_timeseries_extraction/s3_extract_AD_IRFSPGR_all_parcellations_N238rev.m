%% Create timeseries for turbulence across multiple parcellations: AD_IRFSPGR
...
batch_path = { ...
    'ADNI3_AD_IRFSPGR_batch_1_extended','ADNI3_AD_IRFSPGR_batch_2_extended'};

tseries_path = { ...
    'ADNI3_AD_IRFSPGR_batch_1_N238rev','ADNI3_AD_IRFSPGR_batch_2_N238rev'};
...
for batch = 1:numel(batch_path)
    ...
    connIDs_varname  = sprintf('connIDs_BIDS_IRFSPGR_60_89_batch_%d_AD', batch);
    ...
    for p = 1:numel(parcellations)
        ...
        save_filename = sprintf( ...
            'tseries_ADNI3_AD_IRFSPGR_batch_%d_%s_matching_QC.mat', ...
            batch, parc_name);
