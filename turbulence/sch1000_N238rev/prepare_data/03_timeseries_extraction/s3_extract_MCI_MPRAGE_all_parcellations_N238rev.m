%% Create timeseries for turbulence across multiple parcellations: MCI_MPRAGE
%% Create timeseries for turbulence across multiple parcellations: MCI_MPRAGE
...
batch_path = { ...
    'ADNI3_MCI_MPRAGE_batch_1_extended'};

tseries_path = { ...
    'ADNI3_MCI_MPRAGE_batch_1_N238rev'};
...
for batch = 1:numel(batch_path)
    ...
    connIDs_varname  = sprintf('connIDs_BIDS_MPRAGE_60_89_batch_%d_MCI', batch);
    ...
    for p = 1:numel(parcellations)
        ...
        save_filename = sprintf( ...
            'tseries_ADNI3_MCI_MPRAGE_batch_%d_%s_matching_QC.mat', ...
            batch, parc_name);
